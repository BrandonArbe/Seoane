...
namespace Seoane.Presentacion
{
    public partial class FrmArticulo : Form
    {
        ...
        { 
            try
        {
            dgvListar.DataSource = NArticulo.Listar();
            this.Formato();
        ...
        private void Formato()
        {
            ...
            dgvListar.Columns[3].HeaderText = "Descripcion Articulo";
        ...
        private void Buscar()
        {
            ...
            {
                //DECLARO EL ORIGEN
                dgvListar.DataSource = NArticulo.Buscar(txtbusca.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtNombre.Text == String.Empty || txtID.Text == String.Empty)
                {
                    ...
                    this.MensajeError("Falta ingresar datos: Nombre Articulo o ID");
                }
                else
